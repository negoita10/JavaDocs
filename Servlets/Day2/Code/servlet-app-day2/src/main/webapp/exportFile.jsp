...
<script type="text/javascript">
    function exportFile() {
        ...
        if (username != null && username != "") {
            ...
            window.open("/servlet-app-day2/impf?template=UsernameReport" + "&fileType=pdf" + "&username=" +username );
            ...
            // TIP: Remember that the application context it's named servlet-app
            window.open("/servlet-app-day2/impf?template=UsernameReport" + "&fileType=pdf" );
        }
